export const translations = {
  pt: {
    ...
    skills: {
      ...
      lead: "Cada skill abaixo foi verificada no codigo-fonte dos meus projetos, nao apenas citada.",
      all: "Todas",
      proven: "Comprovado em",
      proTag: "experiencia profissional",
      proShort: "Pro",
      legendTitle: "Onde cada skill foi comprovada",
      traceHint: "Clique num projeto para destacar tudo que construi com ele.",
      ...
      stats: {
        ...
        projects: "projetos",
        verified: "comprovado em codigo",
      },
      categories: {
        ai: "IA / Engenharia de LLM",
        languages: "Linguagens",
        backend: "Back-End",
        frontend: "Front-End",
        data: "Bancos & Dados",
        cloud: "Cloud / DevOps",
        reliability: "Observabilidade & Confiabilidade",
        testing: "Testes & Qualidade",
        architecture: "Arquitetura & Padroes",
        integrations: "Integracoes",
        security: "Seguranca & Compliance",
        practices: "Praticas & Metodologia",
    ...
    caseStudy: {
      ...
      diagrams: {
        contextRag: {
          ariaLabel: "Diagrama de Arquitetura RAG",
          lanes: { ingest: "Fluxo de Ingestão", query: "Fluxo de Consulta" },
          nodes: {
            client: "Cliente",
            clientSub: "Browser / API",
            api: "FastAPI",
            redis: "Redis (Broker)",
            redisSub: "Message Broker",
          ...
          legend: {
            blue: "Cliente", accent: "FastAPI", red: "Redis",
            green: "Celery", purple: "pgvector", orange: "LLM",
          },
        },
        scale: {
          ariaLabel: "Arquitetura de Escalabilidade Horizontal",
          nodes: { lb: "Load Balancer", redisSub: "Fila" },
          labels: {
            roundRobin: "Round-robin",
            stateless: "Réplicas stateless",
            backpressure: "Buffer de fila",
            autoScaled: "Auto-scaled",
            readReplicas: "Read replicas",
            caption: "Escalonamento horizontal para 100k+ requisições",
          },
        },
        dataglass: {
          ariaLabel: "Arquitetura AWS Multi-Tenant Dataglass",
          lanes: { web: "Fluxo Web", async: "Fluxo Assíncrono" },
          nodes: {
            browser: "Browser",
            alb: "AWS ALB",
            albSub: "Load Balancer",
            django: "Django + DRF",
            multiTenant: "Multi-Tenant",
            rds: "PostgreSQL RDS",
            rdsSub: "Row-level isolation",
            s3: "AWS S3",
            redis: "Redis",
            redisSub: "Task Broker",
            celery: "Celery Workers",
            tableau: "Tableau Server API",
          },
          sidecars: { ecr: "Docker Images", iam: "Instance Profile" },
          legend: {
            blue: "Browser", orange: "AWS", accent: "Django",
            purple: "RDS", green: "S3 / Celery", red: "Redis",
          },
        },
        encaixe: {
          ariaLabel: "Arquitetura LangGraph Encaixe",
          lanes: {
            ingest: "Fluxo de Ingestão",
            process: "Pipeline LangGraph (Celery Worker)",
          },
          nodes: {
            whatsappSub: "mensagem do usuário",
          ...
          labels: {
            branchSchedule: "intent: scheduling · conf ≥ 0.65",
            branchHandoff: "conf < 0.65 · opt_out",
            branchRespond: "conf ≥ 0.65 · default",
          },
          sidecars: {
            rls: { title: "RLS + GUC app.tenant_id", sub: "defesa em profundidade" },
            idempotency: { title: "Idempotência", sub: "unique (source, external_id)" },
            token: { title: "Token per-instance", sub: "webhook auth · não admin key" },
            logging: { title: "structlog + X-Request-Id", sub: "trace webhook → worker → provider" },
          },
        },
        mcp: {
          ariaLabel: "Arquitetura do Servidor MCP",
          groups: { client: "Cliente MCP", server: "Servidor FastMCP" },
          nodes: {
            ...
            handlers: "Handlers",
            cache: "Redis Cache",
            cacheSub: "TTL 15 min · Rate Limiter",
            github: "GitHub API",
            langchain: "LangChain",
            llm: "Groq / Llama 3",
            result: "Relatório Markdown",
          },
          edges: {
            toolCall: "tool_call (JSON-RPC)",
            result: "resultado estruturado",
          },
          labels: { stack: "Stack" },
        },
        aiComponent: {
          ariaLabel: "Arquitetura do Componente AI",
          groups: {
            user: "Camada do Usuário",
            server: "Servidor Next.js 15",
            runtime: "Runtime do Cliente",
          },
          nodes: {
          ...
          labels: { stateSync: "state sync" },
        },
        dataglassCICD: {
          ariaLabel: "Pipeline CI/CD Dataglass",
          lanes: {
            base: "① Pipeline Base Image (trigger manual)",
            dev: "② Pipeline Dev (push na branch dev)",
            prod: "③ Pipeline Produção (merge de PR na main)",
          },
          branches: { dev: "branch dev", main: "branch main" },
          build: { push: "Build + Push" },
          envs: { dev: "ambiente dev", prod: "produção" },
          sidecars: {
            ecrPython: "Camada base Docker",
            secrets: "Vars injetadas no build",
            codeArtifact: "Cache de pacotes privados",
          },
          labels: { buildInputs: "── Entradas do build ──" },
          metrics: {
  ...
  en: {
    ...
    skills: {
      ...
      lead: "Every skill below is verified in my projects' source code, not just claimed.",
      all: "All",
      proven: "Proven in",
      proTag: "professional experience",
      proShort: "Pro",
      legendTitle: "Where each skill is proven",
      traceHint: "Click a project to highlight everything I built with it.",
    ...
    caseStudy: {
      ...
      diagrams: {
        contextRag: {
          ariaLabel: "RAG Architecture Diagram",
          lanes: { ingest: "Ingestion Flow", query: "Query Flow" },
          nodes: {
            client: "Client",
            clientSub: "Browser / API",
            api: "FastAPI",
          ...
          legend: {
            blue: "Client", accent: "FastAPI", red: "Redis",
            green: "Celery", purple: "pgvector", orange: "LLM",
          },
        },
        scale: {
          ariaLabel: "Horizontal Scale Architecture",
          nodes: { lb: "Load Balancer", redisSub: "Queue" },
          labels: {
            roundRobin: "Round-robin",
            stateless: "Stateless replicas",
            backpressure: "Backpressure",
            autoScaled: "Auto-scaled",
            readReplicas: "Read replicas",
            caption: "Horizontal scaling to handle 100k+ requests",
          },
        },
        dataglass: {
          ariaLabel: "Dataglass AWS Multi-Tenant Architecture",
          lanes: { web: "Web Request Flow", async: "Async Task Flow" },
          nodes: {
            browser: "Browser",
            alb: "AWS ALB",
            albSub: "Load Balancer",
        ...
        encaixe: {
          ariaLabel: "Encaixe LangGraph Architecture",
          lanes: {
            ingest: "Ingestion Flow",
            process: "LangGraph Pipeline (Celery Worker)",
          },
          nodes: {
            whatsappSub: "user message",
            evolution: "Evolution API",
            wsSub: "Baileys (self-hosted)",
          ...
          sidecars: {
            rls: { title: "RLS + GUC app.tenant_id", sub: "defense in depth" },
            idempotency: { title: "Idempotency", sub: "unique (source, external_id)" },
            token: { title: "Token per-instance", sub: "webhook auth · not admin key" },
            logging: { title: "structlog + X-Request-Id", sub: "trace webhook → worker → provider" },
          },
        },
        mcp: {
          ariaLabel: "MCP Server Architecture",
          groups: { client: "MCP Client", server: "FastMCP Server" },
          nodes: {
            claude: "Claude Desktop",
            analyze: "analyze_profile()",
            evaluate: "evaluate_repository()",
        ...
        aiComponent: {
          ariaLabel: "AI Component Architecture",
          groups: {
            user: "User Layer",
            server: "Next.js 15 Server",
        ...
        dataglassCICD: {
          ariaLabel: "Dataglass CI/CD Pipeline",
          lanes: {
            base: "① Base Image Pipeline (manual trigger)",
            dev: "② Dev Pipeline (push to dev branch)",
            prod: "③ Production Pipeline (PR merge to main)",
          },
          branches: { dev: "dev branch", main: "main branch" },
          build: { push: "Build + Push" },
          envs: { dev: "dev environment", prod: "production" },
          sidecars: {
            ecrPython: "Base Docker layer",
            secrets: "Env vars at build time",
            codeArtifact: "Private packages cache",
          },
          labels: { buildInputs: "── Build inputs ──" },
          metrics: {
            deployTotal: "Total deploy",
            envs: "Prod + Dev",
            zeroDowntime: "Zero downtime",
            rollingUpdate: "Rolling update",
          },
